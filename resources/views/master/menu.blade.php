...
@section('title', 'MASTER AUTENTIKASI')
@section('content')
    <div class="row">
        <div class="col-sm-12">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr class="text-center">
                                            <th colspan="2">LIST NAMA MENU</th>
                                        </tr>
                                        <tr class="text-center">
                                            <th>NO</th>
                                            <th>NAMA MENU</th>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                {{-- <td>
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        class="btn btn-sm btn-warning" style="border-radius: 10px;">
                        ...
                        <div class="col-sm-6">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr class="text-center">
                                            <th colspan="2">LIST PEMEGANG MENU</th>
                                        </tr>
                                        <tr class="text-center">
                                            <th>No.</th>
                                            <th>NAMA PEMEGANG MENU</th>
                                            {{-- <th>Tools</th> --}}
                                        </tr>
                                    </thead>
                                    <tbody>
